...
SET _INDIR="/home/aj1m0n/jupter_notebook/20170730/cepstrums"
REM 001 005 010 011 013

SET _OUTFILE="./models/20180730/eval001_005.csv"
SET _MODEL="./models/20180730/model001_005.model"
SET _T=001 005
python create_model.py --indir "/home/aj1m0n/jupyter_notebook/CreateModelFromSpectrumAnnotations/cepstrums" --outeval %_OUTFILE% --outmodel %_MODEL% --timestep 3 --timeshift 1 --car_ids %_T% --eval_car_ids 001 005 010 011 013
