...
class ConvNet1D(nn.Module):
    def __init__(self, in_chan=3, out_chan=64, out_activation='linear'):
        ...
        self.conv1 = nn.Conv1d(in_chan, 32, kernel_size = 8, stride = 4)
...
class DeConvNet1D(nn.Module):
    def __init__(self, in_chan=64, out_chan=3, out_activation='linear', activation='relu',
        ...
        self.conv4 = nn.ConvTranspose1d(64, 32, kernel_size=8, stride=4)
        self.conv5 = nn.ConvTranspose1d(32, out_chan, kernel_size=8, stride=4)
        layers = [self.conv2,
                  nn.ReLU(),
                  self.conv3,
                  nn.ReLU(),
