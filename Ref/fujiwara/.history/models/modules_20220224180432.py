...
class ConvNet1D(nn.Module):
    def __init__(self, in_chan=3, out_chan=64, out_activation='linear'):
        ...
        self.conv1 = nn.Conv1d(in_chan, 128, kernel_size = 8, stride = 4, padding= (6,6))
        self.conv2 = nn.Conv1d(128, 128, kernel_size = 8, stride = 4, padding= (0,1))
        self.conv3 = nn.Conv1d(128, 128, kernel_size = 8, stride = 4, padding= (0,1))
        self.conv4 = nn.Conv1d(128, 256, kernel_size = 8, stride = 4, padding= (0,1))
        layers = [self.conv1,
                  nn.ReLU(),
                  self.conv2,
                  nn.ReLU(),
