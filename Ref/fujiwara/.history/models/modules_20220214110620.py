...
class ConvNet1D(nn.Module):
    def __init__(self, in_chan=3, out_chan=64, out_activation='linear'):
        ...
        self.conv1 = nn.Conv1d(32, 64, kernel_size = 61, stride = 2)
        self.conv1 = nn.Conv1d(64, 128, kernel_size = 61, stride = 2)
        self.conv1 = nn.Conv1d(128, 256, kernel_size = 11, stride = 2)
        self.conv1 = nn.Conv1d(256, out_chan, kernel_size = 1, stride = 1)
