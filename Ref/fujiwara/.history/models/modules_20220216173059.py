...
class ConvNet1D(nn.Module):
    def __init__(self, in_chan=3, out_chan=64, out_activation='linear'):
        ...
        self.conv1 = nn.Conv1d(in_chan, 32, kernel_size = 6, stride = 4)
        self.conv2 = nn.Conv1d(32, 64, kernel_size = 6, stride = 4)
        self.conv3 = nn.Conv1d(64, 128, kernel_size = 6, stride = 4)
        self.conv4 = nn.Conv1d(128, 256, kernel_size = 7, stride = 4)
        layers = [self.conv1,
                  nn.ReLU(),
                  self.conv2,
                  nn.ReLU(),
...
class DeConvNet1D(nn.Module):
    def __init__(self, in_chan=64, out_chan=3, out_activation='linear', activation='relu',
        ...
        self.conv2 = nn.ConvTranspose1d(256, 128, kernel_size=7, stride=4)
        self.conv3 = nn.ConvTranspose1d(128, 64, kernel_size=6, stride=4)
        self.conv4 = nn.ConvTranspose1d(64, 32, kernel_size=6, stride=4)
        self.conv5 = nn.ConvTranspose1d(32, out_chan, kernel_size=6, stride=4)
        layers = [self.conv2,
                  nn.ReLU(),
                  self.conv3,
                  nn.ReLU(),
